...
public class GameTime {
    ...
    public static String getElapsedFormattedTime() {
        ...
        // change here to get milliseconds - time -= TimeUnit.SECONDS.toMillis(seconds);
    ...
    private void update() {
        fpsCount++;
        long currentSeconds = TimeUnit.MILLISECONDS.toSeconds(getElapsedTime());
        if (fpsTimeDelta != currentSeconds) {
            currentFps = fpsCount;
            fpsCount = 0;
        }
        fpsTimeDelta = currentSeconds;
    }
